document.addEventListener("DOMContentLoaded", () => {
    ...
    let products = [
        { name: 'Libamáj Mousse Hagymalekvárral Kaláccsal', tag: 'goose', price: 1000, inCart: 0 },
        { name: 'Lazac Tatár Kevert Salátaágyon Pirítóssal', tag: 'tatar', price: 1000, inCart: 0 },
        ...
        { name: 'BBQ Sertés Oldalas Sörös Serpenyős Burgonyával', tag: 'bbq', price: 1000, inCart: 0 },
        { name: 'Konfitált Sertéscsülök Tepsis Hagymás Burgonyával', tag: 'csülök', price: 1000, inCart: 0 },
        { name: 'Mediterrán Lecsó Zöldfűszeres Sertésszűzzel', tag: 'lecso', price: 1000, inCart: 0 },
        { name: 'Mézes Chilis Lazac Grillezett Zöldségekkel', tag: 'lazac', price: 1000, inCart: 0 },
        { name: 'Epres Nutellás Palacsinta', tag: 'pancake', price: 1000, inCart: 0 },
